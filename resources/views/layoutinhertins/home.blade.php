@extends('layouts.app')
@section('main-class','pt-24 pb-section-gap max-w-container-max mx-auto px-gutter grid grid-cols-1 md:grid-cols-12 gap-8')
@section('title','Home - Ink & Paper')
@section('style')
<style>
...
<ul class="space-y-2">
<li><a class="flex items-center gap-3 text-primary font-bold font-ui-label text-ui-label py-1" href="#"><span class="material-symbols-outlined" data-weight="fill" style="font-variation-settings: 'FILL' 1;">explore</span>Explore</a></li>
...
<img alt="" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" data-alt="A macro photograph of high-quality cream-colored paper with deep black ink strokes, showcasing fine texture and professional calligraphy. The lighting is soft and cinematic, casting gentle shadows that emphasize the physical depth of the ink on the page. The overall aesthetic is minimalist and sophisticated, representing a premium editorial experience with high contrast and clarity." src="https://lh3.googleusercontent.com/aida-public/AB6AXuBBFBSyj6CkyvBOD_SRQ5A-cSY1Cdw5WCfpcpMbK6wt1gNKpKVEBIHZC_rRMCEvC8iTE1zTEYRtsP81jrHP0bo9ffojhdYOzgAhgs1Cz0q8QFqa0nSD_IfSMhW9ztTCe15twvtGHZkIn0PtjzGAqIbQpqDXsAI-wV5oooi_CA4cwuHj96Y1K7UbHK1q_5sWUMDjows8tWRxj4iMYvIBUd-ops3T519EOJ6RlLxzk1jn0Wtk_8HWTjpj__S_xDppqNI1tnhqIX3QSUad"/>
</div>
...
<img alt="" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="A close-up shot of a classic fountain pen resting on an open notebook filled with elegant handwriting. The scene is lit by warm, natural afternoon sunlight coming through a nearby window, creating long, soft shadows. The paper has a subtle grain, and the ink appears rich and saturated, embodying an atmosphere of intellectual focus and traditional craftsmanship." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAtSx0MXlyyHL9GDHEXpmVuFjybH99-q36c7QJTv0fLQwy0bb3eBj178Az7BSSJoknhXuC_7o1TO5kPZgkPkWw6yJq4AsDaf1guCajS-XLG4CGZQdWf_DqrRyYz2887catDIoVg0ESyyurHoHI12XjIlwQkmpdearKFbgD7sR0iEuiBjHsf9_eLT9hloE9e0ZMvny6jI2TH7fAujx5JzCyOoevEgM56_cZpD7VBzsm-j99FpzfXdYfrGKV6LuXD0wvmX0mRJnCkKLyF"/>
</div>
...
<article class="flex flex-col md:flex-row gap-8 group">
<div class="w-full md:w-1/3 aspect-video md:aspect-square overflow-hidden rounded-lg border border-outline-variant">
<img alt="" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" data-alt="A modern office workspace with a clean, white desk featuring a sleek laptop and a single architectural plant. The wall behind is a neutral grey with a single minimalist poster framed in black. The lighting is bright and even, creating a crisp and professional environment that feels organized and serene. The overall style is modern minimalist with a focus on functional clarity." src="https://lh3.googleusercontent.com/aida-public/AB6AXuAYOfwZva0F3aWqjVIFQtGgNkCRYq1JRNEMXBD0AkUlEEjMZc6s0G8_FIOJqlR7yUPsMAgaN5Mdk12msCp-vZTcDx14FpUnXYFZzVv1Fq6wMmIlqAAKNp2s-nOvKHpc67EHg38exnymuQfAi1za4cPulsSu4YQPqnlXKqR-6_4BuLfVgV-Z0U_Bn-6UOhyvzHxMcXiLf5MAHC1XglUgOp2FIPbALir4i9sBSPPX2gTLdVe1K42tVpGIA3mG6VHeWCvjOQoBYKgFVIAu"/>
</div>
<div class="w-full md:w-2/3 space-y-3">
<div class="flex items-center gap-2 font-metadata text-metadata text-secondary">
